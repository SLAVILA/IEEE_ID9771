...
class banco:
    ...
    def chave_estrangeira(self,acao):
        tmp=banco().sql("alter table eleitor %s trigger all" % (acao),(),dic=0)
...
class config:
    ...
    def verificar_config(self, id_cliente):
        variaveis = [
            "dashboard_candidaturas",
            "dashboard_votos",
            "fale_conosco",
            "documentacao",
            "tela_espera",
            "info_chapas",
            "candidatura_base_previa",
            "chapa_com_foto",
            "troca_senha",
            "recupera_senha",
            "auth_token",
            ...
            "possui_video",
            "lista_eleitores_id",
            "lista_eleitores_nome",
            "lista_eleitores_cpf",
            "lista_eleitores_inscricao",
            "lista_eleitores_email",
            "lista_eleitores_telefone",
            "lista_eleitores_setor",
            "lista_eleitores_status",
            "lista_eleitores_voto",
            "lista_candidatos_id",
            "lista_candidatos_nome",
            "lista_candidatos_inscricao",
            "lista_candidatos_email",
            "lista_candidatos_telefone",
            "lista_candidatos_dt_admis",
            "lista_candidatos_dt_cand",
            "lista_candidatos_setor",
            "lista_candidatos_escolha",
            "lista_candidatos_status",
            "lista_candidatos_apelido",
            "lista_candidatos_ord_cand",
            "compr_cand_nome",
            "compr_cand_inscricao",
            "compr_cand_email",
            "compr_cand_telefone",
            "compr_cand_dt_adm",
            "compr_cand_dt_cand",
            ...
            "compr_cand_tag3",
            "compr_cand_tag4",
            "relat_eleitores_nome",
            "relat_eleitores_cpf",
            "relat_eleitores_inscricao",
            "relat_eleitores_email",
            "relat_eleitores_telefone",
            "relat_eleitores_setor",
            "relat_eleitores_escolha",
            "relat_eleitores_status",
            "relat_eleitores_paisagem",
            "relat_eleitores_dt_admis",
            "relat_eleitores_tag1",
            "relat_eleitores_tag2",
            "relat_eleitores_tag3",
            "relat_eleitores_tag4",
            "apura_durante_eleicao",
            "cand_campos_obrig_inscricao",
            "cand_campos_obrig_cpf",
            "foto_obrig_cand",
            "tipo_cipa",
            "lista_eleitores_tag1",
            "lista_eleitores_tag2",
            "lista_eleitores_tag3",
            "lista_eleitores_tag4",
            "teste_espera",
            "teste_candidatura",
            "teste_eleicao",
            "lista_eleitores_logou",
            "lista_candidatos_tag1",
            "lista_candidatos_tag2",
            "lista_candidatos_tag3",
            "lista_candidatos_tag4",
            "lista_candidatos_foto",
            "chat_ativo",
            "senha_por_sms",
            "senha_por_email",
            "login_campos_obrig_cpf",
            "login_campos_obrig_inscricao",
            "possui_chat",
            "possui_chat_externo",
            "possui_termo",
            "voto_impresso",
            "lista_eleitores_presencial",
            "lista_eleitores_pode_votar",
            "senha_por_whatsapp",
            "duvidas",
            "filtro_por_tags",
            "auth_rf",
            "quero_falar",
            "lista_comprovante_nome",
            "lista_comprovante_cpf",
            "lista_comprovante_inscricao",
            "lista_comprovante_email",
            "lista_comprovante_telefone",
            "lista_comprovante_setor",
            "lista_comprovante_status",
            "lista_comprovante_tag1",
            "lista_comprovante_tag2",
            "lista_comprovante_tag3",
            "lista_comprovante_tag4",
            "login_campos_obrig_email",
            "candidatura_openauth",
            "voto_aberto",
            "relat_apuracao",
            "relat_logs",
            "relat_zerezima",
            ...
            "relat_votos_comput",
            "relat_atas_cipa",
            "relat_lista_presenca",
            "relat_votantes_por_pauta",
            "senha_carac_especial",
            "login_campos_obrig_data_nasc",
            "lista_eleitores_tag5",
            "lista_eleitores_tag6",
            "lista_eleitores_dt_admissao",
            "lista_eleitores_dt_nasc",
            "lista_comprovante_tag5",
            "lista_comprovante_tag6",
            "setor_total_dif",
            "relat_eleitores_tag5",
            "relat_eleitores_tag6",
            "assina_chave_publica",
            "google_captcha",
            "google_captcha_voto",
            "acess_visual",
            "google_captcha_rec_senha",
            "chat_outro_servidor",
            "chat_publico",
            "foto_tela_chapas",
            "filtro_pre_voto",
            "relat_apuracao_por_escolhas",
            "relat_eleitores_urna",
            "lista_comprovante_tag7",
            "tag_carrega_setor",
            "relat_apuracao_por_tags",
            "relat_apuracao_por_setor",
            "relat_eleitores_setor",
            "relat_votantes_setor",
            "relat_nao_votantes_setor",
            "relat_nao_votantes_por_escolha",
            "relat_votantes_por_escolha",
            "relat_eleitores_por_escolha",
            "relat_apuracao_chave_privada",
            "visib_custom_1",
            "visib_custom_2",
            "cand_lista_chapas",
            "auth_app",
            ...
            "relat_logs_cand",
            "relat_logs_bo",
            "relat_apuracao_por_escolha_setor",
            "relat_eleitores_por_escolha_setor",
            "relat_votantes_por_escolha_setor",
            "relat_nao_votantes_por_escolha_setor",
            "relat_cand_setor",
            "relat_cand_escolha_setor",
            "relat_cand_escolha",
            "relat_tabela_tamanho_automatico",
            "relat_repetir_cabecalho",
            "metodo_voto_bot",
            "metodo_voto_web",
            "metodo_voto_app",
            "metodo_voto_ura",
        ...
        variaveis_txt = [
            "texto_tela_espera",
            "texto_tela_candidatura",
            "assunto_email_envio_senha",
            "texto_email_envio_senha",
            "texto_sms_envio_senha",
            "nomenclatura_login",
            "texto_tela_eleicao",
            "texto_tela_login",
            "texto_tela_senha",
            "texto_tela_rec_senha",
            "ips_teste",
            "endereco_certificado_digital",
            "nomenclatura_inscricao",
            "cor_sistema",
            "assunto_email_envio_compr_votacao",
            "texto_email_envio_comprovante_votacao",
            "assunto_email_envio_senha_admin",
            "texto_email_envio_senha_admin",
            "assunto_email_envio_convite_cand",
            "texto_email_envio_convite_cand",
            "nomenclatura_setor",
            "nomenclatura_eleitor_tag1",
            "nomenclatura_eleitor_tag2",
            "nomenclatura_eleitor_tag3",
            "nomenclatura_eleitor_tag4",
            "lista_emails_aviso_candidatura",
            "texto_email_aviso_candidatura",
            "assunto_email_aviso_candidatura",
            "link_youtube",
            "envio_email",
            "envio_sms",
            "nomenclatura_cand_tag1",
            "nomenclatura_cand_tag2",
            "nomenclatura_cand_tag3",
            "nomenclatura_cand_tag4",
            "nomenclatura_cand_tag5",
            "nomenclatura_cand_tag6",
            "nomenclatura_cand_tag7",
            "assunto_email_comunicacao_geral",
            "texto_email_comunicacao_geral",
            "texto_espera_liberacao_pergunta",
            "nomenclatura_usuario_tag1",
            "nomenclatura_usuario_tag2",
            "nomenclatura_usuario_tag3",
            "nomenclatura_usuario_tag4",
            "nomenclatura_pauta_tag1",
            "nomenclatura_pauta_tag2",
            "nomenclatura_pauta_tag3",
            "nomenclatura_pauta_tag4",
            "nomenclatura_escolha_tag1",
            "nomenclatura_escolha_tag2",
            "nomenclatura_escolha_tag3",
            "nomenclatura_escolha_tag4",
            "texto_termo",
            "total_urnas",
            "texto_tela_troca_senha",
            "recsenha_campos_obrig_inscricao",
            "recsenha_campos_obrig_cpf",
            "perc_quorum",
            "texto_whatsapp_envio_senha1",
            "texto_whatsapp_envio_senha2",
            "texto_whatsapp_envio_senha3",
            "fone_suporte",
            "link_sala_zoom",
            "numero_sala_zoom",
            "tipo_transmissao_video",
            "texto_tela_candidatura_1",
            "ordem_cand",
            "padrao_senha",
            "tamanho_senha",
            "texto_erro_login_nao_encontrado",
            "texto_erro_nao_apto_ao_voto",
            "tag_grupo_eleitores",
            "tag_peso_voto",
            "nomenclatura_eleitor_tag5",
            "nomenclatura_eleitor_tag6",
            "nomenclatura_eleitor_tag7",
            "eleitor_tam_fonte",
            "eleitor_l_col_nome",
            "eleitor_l_col_cpf",
            "eleitor_l_col_inscricao",
            "eleitor_l_col_email",
            "eleitor_l_col_telefone",
            "eleitor_l_col_setor",
            "eleitor_l_col_tag1",
            "eleitor_l_col_tag2",
            "eleitor_l_col_tag3",
