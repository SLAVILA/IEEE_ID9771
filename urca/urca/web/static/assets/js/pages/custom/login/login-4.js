	...
	var _handleFormSignin = function () {
		...
		FormValidation
			...
			.on('core.form.valid', function () {
				...
				var login = form.querySelector('[name="username"]').value;

				$.post("/_login", { login: login })
					.done(function (data) {
						...
						if (res.status == '1') {
							...
							var senha = form.querySelector('[name="password"]').value;
							$.post("/_login_senha", { senha: senha })
								.done(function (data) {
									var res = JSON.parse(data);
									...
									if (res.status == '1') {
										...
										Swal.fire({
											text: "Logado com sucesso, você será redirecionado para o painel!",
											icon: "success",
											buttonsStyling: false,
											confirmButtonText: "Ok, ir agora!",
											customClass: {
												confirmButton: "btn font-weight-bold btn-light-primary"
											}
										}).then(function () {
